...
- **UI Components**: `src/features/fabrication/FabricationWorks.jsx` (QA Inspection dialog, Defect modal, Kanban board), `src/features/fabrication/FabricationCardDetails.jsx` (Milestone checklist, A4 ticket printout)
- **CRM Integration**: `src/features/deals/Deals.jsx` (Deal completion invoice trigger), `src/features/leads/Leads.jsx` (Project creation on deal conversion)
...
* **Location**: `src/features/fabrication/FabricationCardDetails.jsx:L747-L791`
